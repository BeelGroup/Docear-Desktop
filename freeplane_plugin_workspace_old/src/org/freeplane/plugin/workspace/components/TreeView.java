...
import org.freeplane.plugin.workspace.controller.DefaultTreeExpansionListener;
import org.freeplane.plugin.workspace.controller.DefaultWorkspaceSelectionListener;
...
public class TreeView extends JPanel {
	...
	public TreeView() {
		...
		m_tree.addTreeExpansionListener(new DefaultTreeExpansionListener());
		m_tree.addTreeSelectionListener(new DefaultWorkspaceSelectionListener());
