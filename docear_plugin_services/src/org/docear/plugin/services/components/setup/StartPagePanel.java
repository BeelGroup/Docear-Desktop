package org.docear.plugin.services.components.setup;
...
public class StartPagePanel extends AWizardPage {
	...
	public StartPagePanel(DocearUser startSettings) {
		...
		JHyperlink lblForgotPasswd = new JHyperlink(TextUtils.getText("docear.setup.wizard.login.forgot.passwd"), "https://www.docear.org/?forgot_password=1");
