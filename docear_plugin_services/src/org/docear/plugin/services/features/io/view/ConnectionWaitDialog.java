...
public class ConnectionWaitDialog {
	...
	public void start() {
		synchronized (started) {
			if (!started) {
				started = true;
				JOptionPane.showOptionDialog(UITools.getFrame(), waitPanel, TextUtils.getOptionalText("docear.service.connect.title"),
						JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null, dialogButtons, dialogButtons[0]);
			}
		}
