...
//		this.controller = controller;
	...
	private void createStandardControllers() {
		...
		modeController.getMapController().addMapLifeCycleListener(userInputListenerFactory.getRibbonBuilder().getMapChangeAdapter());
...
//		keyProcessor.addKeyStrokeProcessor(userInputListenerFactory.getMenuBuilder());
		...
		userInputListenerFactory.getRibbonBuilder().getAcceleratorManager().setAcceleratorChangeListener(fButtonToolBar);
