...
//WORKSPACE - todo: 
	...
	public static boolean allVariablesSet() {
		...
		//WORKSPACE - todo: every project has it's own observers
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			}
			{
						...
						FormFactory.DEFAULT_ROWSPEC,}));
				{
					...
					literatureLocation = new LocationDialogPanel(null, getLiteratureLocation(), true);
				...
				}
				{
					...
					bibtexLocation = new LocationDialogPanel(null, getBibtexLocation(), false, bibFilter);
				...
				}
				{
					...
					projectsLocation = new LocationDialogPanel(null, getProjectsLocation(), true);
